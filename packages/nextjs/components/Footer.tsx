...
export function Footer({ className }: FooterProps) {
  return (
    <footer className={cn("container mt-10 flex flex-wrap justify-center pb-16 pt-10", className)}>
      <div className="flex basis-full justify-between gap-8 md:basis-auto md:flex-col md:justify-start flex-col items-center">
        ...
        <div className="flex items-center gap-5 flex-row">
          <a href="https://github.com/devjutsu/cryptojam" className="text-muted-foreground hover:text-foreground">
          ...
          <a href="https://x.com/devjutsu" className="text-muted-foreground hover:text-foreground">
          ...
          <a
            href="https://youtu.be/hn-8n0BjdR4?si=EMrjpofDlFdaxh2U"
